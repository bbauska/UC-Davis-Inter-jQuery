...
lesson. But in this lesson, we\'ll look at the **flex slider** plugin,
...
**[Step 2]{.mark},** you need to make sure jQuery is linked. The jQuery
...
**[Step 3]{.mark},** is to link the plugin file and when you download a
...
**[Step 4]{.mark},** link to the plug in CSS file, some of the fancier
...
[Then **Step 5**]{.mark}, is you need to initialize the setup of the
...
The second, **[number 2]{.mark}** thing is file management. When you
...
The next thing, **[number 3]{.mark}** is top of the page versus bottom
...
Now, jQuery has a document ready method, **[number 4]{.mark}** that will
...
Then the last, **[number 5]{.mark}** is overriding CSS on your
...
### **jQuery Plugins** {#jquery-plugins .unnumbered}
...
### **Start Files: jQuery Plugins & FexSlider** {#start-files-jquery-plugins-fexslider .unnumbered}
...
pound forth and fifth. Which again match the IDs down here (botttom of
...
that by using some \[inaudible\] animations to do this, instead of this
...
we aren\'t setting \[inaudible\] and we aren\'t setting the amount of
...
a chicken, **person.pets\[2\]**. It gets me the chicken or I could do a
...
the data so I could use user.last_name or user.social media\[0\] to get
...
to the objects so I could have user.social_media\[3\] wordpress.com, if
...
zeroed out. So **gameData.score, \[gameData.index\]**, Is going to be
...
it\'s really this line again. + **gameData.rollSum\[\]**. Like that, I
...
player x is going to be variable. So we\'re going to do \${}. And in
...
**gameData.players\[0\]**, is going to be something. And what score is
...
**gameData.score\[0\]**. So that\'s the first player\'s score, and then
...
believe that\'s all we need let\'s just see over here, yep. Players\[0\]
